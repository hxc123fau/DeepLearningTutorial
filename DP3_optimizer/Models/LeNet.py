...
class LeNet:
    ...
    def build(self):
        ...
        # Optimizers.Adam.add_regularizer(Constraints.L2_Regularizer(4e-4))
        optimizer = Optimizers.Adam(5e-4, 0.98, 0.999)
        # lenet_regularizer=Constraints.L2_Regularizer(4e-4)
        ...
        # print('input_image_shape0',input_image_shape,'conv_stride_shape',conv_stride_shape)
        ...
        # print('conv_2_out_shape',conv_2_out_shape)


        net.layers.append(Flatten.Flatten())

        categories_1 = 84
        # print('categories_1',categories_1)
        fcl_1 = FullyConnected.FullyConnected(fully_batch_size, categories_1)
        net.append_trainable_layer(fcl_1)  # 因为fully还需要optimizer，所以从neural中这个函数里加进self.layers
